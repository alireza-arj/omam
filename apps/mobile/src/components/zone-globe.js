...
function toCartesian([latDeg, lonDeg]) {
...
export function ZoneGlobe() {
    ...
    return (_jsxs(View, { className: "items-center gap-2", children: [_jsx(Text, { className: "text-base font-medium text-[#232126]", children: "Zone" }), _jsxs(Canvas, { style: { width: 116, height: 116 }, children: [_jsx(Circle, { cx: CENTER, cy: CENTER, r: 47.5, color: "#3f3c44", style: "stroke", strokeWidth: 1.2, opacity: 0.32 }), _jsx(Circle, { cx: CENTER, cy: CENTER, r: 41, color: "#2a2730", style: "stroke", strokeWidth: 0.9, opacity: 0.22 }), _jsx(Circle, { cx: CENTER, cy: CENTER, r: 39, color: "#17151a", opacity: 0.06 }), projectedDots.map((dot) => (_jsx(Circle, { cx: dot.x, cy: dot.y, r: dot.r, color: "#17151a", opacity: dot.opacity }, dot.key))), _jsx(Circle, { cx: CENTER, cy: CENTER, r: 3, color: "#17151a" })] })] }));
}
